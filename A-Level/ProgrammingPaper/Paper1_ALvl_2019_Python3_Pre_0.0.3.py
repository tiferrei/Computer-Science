...
def ShowHelp():
    ...
    print("  examine - Examine location or item.")
    print("  open - Open door or item.")
    print("  close - Close door or item.")
    print("  move - Move item.")
    print("  say – Make the character say text.")
    print("  playdice - Roll your dice.")
    print("  help - Print this help screen.")
    print("  quit - Exit the game.")

def ExamineRoom(Items, Places, Character):
    print()
    print()
    print(Places[Character.CurrentLocation - 1].Description)
    DisplayGettableItemsInLocation(Items, Character.CurrentLocation)
